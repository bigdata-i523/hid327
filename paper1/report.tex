...
this involves looking at corporate ownership, who they use as a billing agent, who they 
tend to refer patients to for other service in order to uncover a larger pattern of 
FWA collusion.\cite{RevCycle}
...
including inpatient, outpatient, and pharmaceuticals. This data in analyzed by knowledge based on 
clinical classifications and medical literature.  This helps to identify wasteful or unnecessary 
...
incorporates the rules and models into the claims process so companies can proccess them against 
all of their claims instead of samples sets.  This helps to uncover more schemes and ``spot 
linked entities and crime rings, which can help stem larger losses.''\cite{SASFraud}.  The 
...
immediately.''\cite{LexisNexis}  We have the technology today which will help protect the
