...
the US in 2016.  (BLSOnDemandDrivers)  Another 687,200 people were employed as 
bus drivers with an average pay of \$31,920.  (BLSBusDrivers)  Combined this is 
...
with an average salary of \$41,340.  (BLSBigTrucks) In addition delivery truck 
drivers employed another 1,421,400 people with an average wage of \$28,390.  
(BLSDeliveryDrivers)  
...
million.  (BLSUSEmployment)  Comparing the employment numbers shows that 
...
drivers, some estimates up to 90% fewer accidents will mean less need for the 
